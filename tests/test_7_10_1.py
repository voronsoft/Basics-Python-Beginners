...
def test_7_10_1(path_tmp_file: str, task_num_test: str):
    ...
    try:
        ...
        with stream_interceptor(stdin_data="7", capture_stdout=True, capture_stderr=True) as streams:
        ...
        try:
            res = test_7_10_1_1(path_tmp_file)
            result.append(res)
...
def test_7_10_1_1(path_tmp_file: str):
