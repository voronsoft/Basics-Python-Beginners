# 3_6_12 тест для задачи
import subprocess


def test_3_6_12(path_tmp_file: str, task_num_test: str):
    """Функция тестирования кода пользователя"""
    # Входные данные
    test_input = (
        "Рим Токио Ханой",
        "Рим Мадрид Вена",
        "Чикаго Майами Торонто Монреаль",
    )
    # Ожидаемый результат
    expected_output = (
        "Дублин Киев Прага Рим Токио Ханой",
        "Дублин Киев Прага Рим Мадрид Вена",
        "Дублин Киев Прага Чикаго Майами Торонто Монреаль",
    )
