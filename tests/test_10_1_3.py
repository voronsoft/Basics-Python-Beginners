...
def test_10_1_3(path_tmp_file: str, task_num_test: str):
    ...
    try:
        ...
        if "2**1" not in code and "2**0" not in code:
            raise RuntimeError(
        ...
        # Функциональный тест
        try:
            res = test_10_1_3_1(path_tmp_file)
            result.append(res)
...
def test_10_1_3_1(path_tmp_file: str):
