# 6_5_6 тест для задачи
import subprocess


def test_6_5_6(path_tmp_file: str, task_num_test: str):
    """Функция тестирования кода пользователя"""
    # Входные данные 
    test_input = (
        "Лондон Дублин Варшава  Лондон\nЛондон Прага Варшава Дублин Вена Лондон",
        "Лондон Дублин Варшава Осло\nЛондон Вена Дублин Варшава Осло",
        "Лондон Вена Осло\nЛагос Дели Амстердам",
        "Дели Йоркшир Лагос Дели\nДели Варшава Йоркшир Лондон Вена",
        "Лондон Дублин Варшава\nОлндон Нублид Авршава",
        "Лондон Лагос Йоркшир Лондон\nЛагос Лондон Йоркшир",
    )
    # Ожидаемый результат
    expected_output = (
        "ДА",
