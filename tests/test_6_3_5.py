...
def test_6_3_5(path_tmp_file: str, task_num_test: str):
    """Функция тестирования кода пользователя"""
    # Входные данные
    test_input = (
        "Афины Будапешт Амстердам Брюссель Стокгольм Осло Копенгаген",
        "Амстердам Брюссель Стокгольм Осло Копенгаген",
        "Амстердам Брюссель",
    )
    # Ожидаемый результат
    expected_output = (
        "Афины Будапешт Брюссель Стокгольм Осло Копенгаген",
        "Брюссель Стокгольм Осло Копенгаген",
        "Брюссель",
    )
