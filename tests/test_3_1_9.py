# 3_1_9 тест для задачи
import subprocess
import sys


def test_3_1_9(path_tmp_file: str, task_num_test: str):
    """Функция тестирования кода пользователя"""
    # Входные данные
    test_input = ("hello Balakirev", "python")
    # Ожидаемый результат
    expected_output = ("Строка: hello Balakirev. Длина: 15", "Строка: python. Длина: 6")
