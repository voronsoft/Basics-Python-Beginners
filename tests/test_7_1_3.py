...
def test_7_1_3(path_tmp_file: str, task_num_test: str):
    ...
    try:
        ...
        try:
            res = test_7_1_3_1(path_tmp_file)
            result.append(res)
...
def test_7_1_3_1(path_tmp_file: str):
    """Функция тестирования кода пользователя"""

    # Входные данные
    test_input = ("",)
    # Ожидаемый результат
    expected_output = ("It's my first function",)
