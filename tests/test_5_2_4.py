# 5_2_4 тест для задачи
import subprocess
import sys


def test_5_2_4(path_tmp_file: str, task_num_test: str):
    """Функция тестирования кода пользователя"""
    # Входные данные
    test_input = (
        "Лондон Варшава Дублин Хельсинки",
        "Лондон Варшава Дублин Хельсинки Осло",
        "Осло Рига Лондон Варшава Дублин Хельсинки",
    )
    # Ожидаемый результат
    expected_output = (
        "ДА",
