# 3_5_5 тест для задачи
import subprocess
import sys


def test_3_5_5(path_tmp_file: str, task_num_test: str):
    ...
    expected_output = (
        ...
        "Вы можете получить 9$ за 1000 рублей по курсу 103.33",
        "Вы можете получить 23$ за 1000 рублей по курсу 42.51",
    )
