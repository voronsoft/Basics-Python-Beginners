# 3_1_4 тест для задачи
import subprocess


def test_3_1_4(path_tmp_file: str, task_num_test: str):
    """Функция тестирования кода пользователя"""
    # Входные данные
    test_input = ("hello python\ni love you", "word1 word2\nword3 word4")
    # Ожидаемый результат
    expected_output = ("hello python i love you", "word1 word2 word3 word4")
