...
def test_9_1_8(path_tmp_file: str, task_num_test: str):
    ...
    try:
        ...
        try:
            res = test_9_1_8_1(path_tmp_file)
            result.append(res)
...
def test_9_1_8_1(path_tmp_file: str):
    """Функция тестирования кода пользователя"""
    # Входные данные
    test_input = ('abcdefghijklmnopqrstuvwxyz',)
    # Ожидаемый результат
    expected_output = (
        "Афины Будапешт Амстердам Брюссель Стокгольм Осло Афины Будапешт Амстердам Брюссель Стокгольм Осло Афины Будапешт Амстердам Брюссель Стокгольм Осло Афины Будапешт",
    )
