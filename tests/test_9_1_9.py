...
def test_9_1_9(path_tmp_file: str, task_num_test: str):
    ...
    try:
        ...
        try:
            res = test_9_1_9_1(path_tmp_file)
            result.append(res)
...
def test_9_1_9_1(path_tmp_file: str):
    ...
    expected_output = (
        ...
        "0.0 -0.02 -0.04 -0.06 -0.08 -0.1 -0.12 -0.14 -0.16 -0.18 -0.2 -0.21 -0.23 -0.25 -0.27 -0.29 -0.31 -0.33 -0.34 -0.36",
    )
