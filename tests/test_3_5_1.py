...
def test_3_5_1(path_tmp_file: str, task_num_test: str):
    ...
    # Ожидаемый результат
    expected_output = (
        "Уважаемый Dilan Forest! Поздравляем Вас с 35-летием!",
        "Уважаемый Roma Quin! Поздравляем Вас с 25-летием!",
    )
