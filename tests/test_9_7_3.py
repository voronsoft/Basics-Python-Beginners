...
def test_9_7_3(path_tmp_file: str, task_num_test: str):
    ...
    try:
        ...
        try:
            res = test_9_7_3_1(path_tmp_file)
            result.append(res)
...
def test_9_7_3_1(path_tmp_file: str):
    """Функция тестирования кода пользователя"""
    # Входные данные
    test_input = (
        "до фа соль до ре фа ля си",
        "фа соль ля ми ре ми соль",
    )

    # Ожидаемые данные вывода
    expected_output = (
        "до до ре фа фа соль ля си",
        "ре ми ми фа соль соль ля",
    )
