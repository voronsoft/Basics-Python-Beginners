...
def test_7_1_4(path_tmp_file: str, task_num_test: str):
    ...
    try:
        ...
        try:
            res = test_7_1_4_1(path_tmp_file)
            result.append(res)
...
def test_7_1_4_1(path_tmp_file: str):
    ...
    expected_output = (
        ...
        "Уважаемый, Василий Лютиков! Вы верно выполнили это задание!",
    )
