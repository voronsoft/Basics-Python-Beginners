# 5_1_2 тест для задачи
import subprocess
import sys


def test_5_1_2(path_tmp_file: str, task_num_test: str):
    ...
    try:
        ...
        if not string_prefixes in user_code:
            raise ValueError(
                "------------- FAIL Тест -------------\n" "Вы не использовали 'while' в своем коде, не хитрите )))"
            )
