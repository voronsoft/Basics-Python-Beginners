# 3_6_13 тест для задачи
import subprocess
import sys


def test_3_6_13(path_tmp_file: str, task_num_test: str):
    ...
    # Ожидаемый результат
    expected_output = (
        "Рим Токио Ханой Дублин Киев Прага",
        "Рим Мадрид Вена Дублин Киев Прага",
        "Чикаго Майами Торонто Монреаль Дублин Киев Прага",
    )
