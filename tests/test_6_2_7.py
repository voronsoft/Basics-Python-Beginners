# 6_2_7 тест для задачи
import subprocess


def test_6_2_7(path_tmp_file: str, task_num_test: str):
    ...
    expected_output = (
        ...
        "палатка брезент молоток карандаш спички",
        "палатка брезент удочка брюки котелок молоток зонт пила рубашка бумага зеркальце расческа карандаш спички",
