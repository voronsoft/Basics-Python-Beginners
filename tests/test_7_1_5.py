...
def test_7_1_5(path_tmp_file: str, task_num_test: str):
    ...
    try:
        ...
        try:
            res = test_7_1_5_1(path_tmp_file)
            result.append(res)
...
def test_7_1_5_1(path_tmp_file: str):
