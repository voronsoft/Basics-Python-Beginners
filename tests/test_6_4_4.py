...
def test_6_4_4(path_tmp_file: str, task_num_test: str):
    """Функция тестирования кода пользователя"""
    # Входные данные
    test_input = (
        "Мама мыла раму а потом мыла кота и еще мыла пол",
        "Предложение состоит из десяти слов и состоит из одного повторения ",
        "один два три один два три четыре пять шесть семь восемь девять четыре",
    )
    # Ожидаемый результат
    expected_output = (
        "9",
