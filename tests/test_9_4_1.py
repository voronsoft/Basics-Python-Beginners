...
def test_9_4_1(path_tmp_file: str, task_num_test: str):
    ...
    try:
        ...
        try:
            res = test_9_4_1_1(path_tmp_file)
            result.append(res)
...
def test_9_4_1_1(path_tmp_file: str):
    """Функция тестирования кода пользователя"""
    # Входные данные
    test_input = (
        "Каир Найроби Лагос Оттава Бразилиа Лима Сантьяго",
        "Сеул Манила Дели Сантьяго Бангкок Каракас",
    )

    # Ожидаемые данные вывода
    expected_output = (
        "Найроби Оттава Бразилиа",
        "Манила Сантьяго Бангкок",
    )
