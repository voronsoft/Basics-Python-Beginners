# 2_4_4 тест для задачи
import subprocess


def test_2_4_4(path_tmp_file: str, task_num_test: str):
    """Функция тестирования кода пользователя"""
    # Входные данные
    test_input = ("I love", "hello python")
    # Ожидаемый результат
    expected_output = ("Word 1: I | Word 2: love", "Word 1: hello | Word 2: python")
