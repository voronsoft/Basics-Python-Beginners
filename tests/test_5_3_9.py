# 5_3_9 тест для задачи
import subprocess


def test_5_3_9(path_tmp_file: str, task_num_test: str):
    """Функция тестирования кода пользователя"""
    # Входные данные
    test_input = (
        "Токио Осака Амстердам Мадрид Дублин Нью-Йорк Кейптаун",
        "Вологда Архангельск Курск Москва",
        "Вологда Казань",
        "Кишинев Владимир Рязань Новгород",
        "Кишинев Владимиры Рязань Новгород",
        "Кишинев Владимир Рязанъ Новгород",
        "Зауральск Саратов Владимир Рязанъ",
    )
    # Ожидаемый результат
    expected_output = (
        "ДА",
