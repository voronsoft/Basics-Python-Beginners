...
def test_5_4_1(path_tmp_file: str, task_num_test: str):
    """Функция тестирования кода пользователя"""
    # Входные данные
    test_input = (
        "Барабанщик бил бой в барабан",
        "Евгений Онегин",
        "Одинокий рабочий долго работал на работе",
        "рар",
        "Одинокий рабочий долго работал на рботе",
        "Арарат",
    )
    # Ожидаемый результат
    expected_output = (
