# 5_2_5 тест для задачи
import subprocess


def test_5_2_5(path_tmp_file: str, task_num_test: str):
    """Функция тестирования кода пользователя"""
    # Входные данные
    test_input = (
        "Петр Анна Иван Сергей Михаил Федор",
        "Петр Иван Сергей Михаил Федор",
        "Петр Иван Михаил Анна Кирилл",
        "Петр Иваи Михаил Апна Кирилл",
    )
    # Ожидаемый результат
    expected_output = (
        "ДА",
