...
def test_9_2_1(path_tmp_file: str, task_num_test: str):
    ...
    try:
        ...
        try:
            res = test_9_2_1_1(path_tmp_file)
            result.append(res)
...
def test_9_2_1_1(path_tmp_file: str):
    ...
    try:
        for i in range(len(test_input)):
            ...
            get_sum = getattr(user_module, "get_sum")  # Получаем функцию из модуля

            # Выполняем функцию
            data = int(test_input[i])
            answer = tuple(get_sum(data))
