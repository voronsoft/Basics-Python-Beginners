...
def test_7_1_7(path_tmp_file: str, task_num_test: str):
    ...
    try:
        ...
        try:
            res = test_7_1_7_1(path_tmp_file)
            result.append(res)
...
def test_7_1_7_1(path_tmp_file: str):
    ...
    expected_output = (
        ...
        "Периметр прямоугольника, равен 94",
    )
