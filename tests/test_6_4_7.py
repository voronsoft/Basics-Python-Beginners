# 6_4_7 тест для задачи
import subprocess


def test_6_4_7(path_tmp_file: str, task_num_test: str):
    ...
    test_input = (
        ...
        "Кирилл Жарков: хахаха я все понял!\nМихаил Крыжановский: учусь по этим урокам\nИван Романенко: благодарю",
        "Анатолий Рипак: весело\nRoman Inshakov: лайк и подписка!\nAleksey Mikhnin: чего лайк то, так себе!\nRoman Inshakov: а мне нравится!\nАнатолий Рипак: снова весело",
    )
    # Ожидаемый результат
    expected_output = (
        "4",
