# 3_7_2 тест для задачи
import subprocess


def test_3_7_2(path_tmp_file: str, task_num_test: str):
    ...
    fail_string = 'print([1434, 1320, 923, 874])'

    if fail_string in user_code:
        raise ValueError(
            "------------- FAIL Тест -------------\n"
            "Очень смешно, видимо вы не особо хотите учиться в вашем коде есть :\n"
            "print([1434, 1320, 923, 874])\nИспользуйте срезы !!!"
        )
    ...
    # Ожидаемый результат
    expected_output = "[1434, 1320, 923, 874]"
    ...
    try:
        ...
        test_result.append(f"Входные данные: v = [1205, 1101, 1434, 1320, 923, 874]")
        ...
        if output == expected_output:
            ...
            raise ValueError(
                f"------------- FAIL Тест: 1 --------\n"
                f"Входные данные: v = [1205, 1101, 1434, 1320, 923, 874]\n"
