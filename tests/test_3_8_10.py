# 3_8_10 тест для задачи
import subprocess
import sys


def test_3_8_10(path_tmp_file: str, task_num_test: str):
    """Функция тестирования кода пользователя"""
    # Входные данные
    test_input = (
        "Волга Нил Амазонка Миссисипи Янцзы",
        "Конго Ганг Дунай Енисей Лена Обь",
        "Темза Дон Эльба Рейн",
    )
    # Ожидаемый результат
    expected_output = (
        "Волга Миссисипи Нил Янцзы",
        "Дунай Енисей Конго Лена Обь",
        "Рейн Темза Эльба",
    )
