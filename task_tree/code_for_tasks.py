...
code_tasks = {
    "task_10_1_1.py": """# Заполните пропуски для перевода 0xa9 в десятичную систему:
# a = 10 (шестнадцатеричная цифра 'a' = 10 в десятичной системе)
# 9 = 9 (остается 9)

answer = (___ * 16**1 + ___ * 16**0)""",
    "task_10_1_2.py": """# Заполните пропуски для перевода 7.8e2 в десятичную систему:

answer = ___ * 10**___""",
    "task_10_1_3.py": """# Заполните пропуски для перевода 0b1010 в десятичную систему:

answer = ___ * 2**3 + ___ * 2**2 + ___ * 2**1 + ___ * 2**0""",
    "task_10_1_4.py": """# Заполните пропуски для перевода 0b101101 в десятичную систему:

answer = ___ * 2**_ + ___ * 2**_ + ___ * 2**_ + ___ * 2**_ + ___ * 2**1 + ___ * 2**0""",
    "task_10_1_6.py": """# Заполните пропуски для перевода 0xa9 в десятичную систему:

answer = ___ * 16**1 + ___ * 16**0""",
    "task_10_1_7.py": """# Заполните пропуски для перевода 0xcf в десятичную систему:

answer = ___ * 16**1 + ___ * 16**0""",
    "task_10_1_8.py": """# Заполните пропуски для перевода 0o10 в десятичную систему:

answer = ___ * 8**1 + ___ * 8**0""",
    "task_10_1_9.py": """# Заполните пропуски для перевода 0o54 в десятичную систему:
