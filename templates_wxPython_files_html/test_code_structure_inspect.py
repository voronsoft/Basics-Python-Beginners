...
def test_0_0_0(path_tmp_file: str, task_num_test: str):
    ...
    try:
        ...
        try:
            res = test_0_0_0_1(path_tmp_file, task_num_test)
            result.append(res)
...
def test_0_0_0_1(path_tmp_file: str, task_num_test: str):
